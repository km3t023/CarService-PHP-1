...
$StariIDServisaZaIzmenu=$_POST['IDServisa'];
...
// KONEKTOVANJE NA BAZU
	...
	$RadObject->UcitajKolekcijuSvihRadova();
	$KolekcijaZapisa= $RadObject->Kolekcija;
	$UkupanBrojZapisa= $RadObject->BrojZapisa;
	...
	$RadoviObject->UcitajIzvrseneRadovePoIDServisu($StariIDServisaZaIzmenu);
	$KolekcijaZapisaEvidencija= $RadoviObject->Kolekcija;
	$UkupanBrojZapisaEvidencija = $RadoviObject->BrojZapisa;
	
	if ($UkupanBrojZapisaEvidencija>0) 
	{
		$row=0;
		$StariIDServisa=$RadoviObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaEvidencija, $row, 0);//mysql_result($result,$row,"REGISTARSKIBROJ");
		$StariBrojSasije=$RadoviObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaEvidencija, $row, 1);
		$StariRadovi=$RadoviObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaEvidencija, $row, 2);
		$StaroImePrezimeKlijenta=$RadoviObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaEvidencija, $row, 3);
		$StariBrRadnihSati=$RadoviObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaEvidencija, $row, 4);
		$StariDatumPocetkaRadova=$RadoviObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaEvidencija, $row, 5);
		$StariDatumKrajaRadova=$RadoviObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaEvidencija, $row, 6);
		$StaraCena=$RadoviObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisaEvidencija, $row, 7);  // prvi i jedini red ima taj id
	}         
...
<meta charset="UTF-8">
<head>
<title>ЕВИДЕНЦИЈA ИЗВРШЕНИХ УСЛУГА МАЈСТОРА ЗА АУТОМОБИЛ</title>
<meta charset="UTF-8">
