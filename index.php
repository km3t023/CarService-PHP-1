...
// koristimo klasu za poziv procedure za konekciju
    ...
    {	
		...
		$RadoviViewObject = new DBMajstor($KonekcijaObject,"izvrsenirad");
		if (isset($_GET['filtriraj']))
			{
				// prikaz filtriranih podataka primenom pogleda nad kojim je dodat filter
				$filter=$_GET['filter'];
				$RadoviViewObject->DajSvePodatkeOIzvrsenimRadovima($filter);
			...
			else
			{
				...
				$RadoviViewObject->DajSvePodatkeOIzvrsenimRadovima($filter);
				// sada raspolazemo sa:
				//$RadoviViewObject->Kolekcija 
				//$RadoviViewObject->BrojZapisa
			}
